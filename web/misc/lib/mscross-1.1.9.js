...
function msMap(DivTag, ControlType, p_protocol) {
  ...
  var _iconLoading = 'misc/img/carga-iloveimg-resized.gif';
  ...
  */
  ...
  this.setActionZoomIn = function () {
    if (isNaN(_tagLoading.style.display)) { i.zoomPerc(1.40); i.redraw(); }
  }
...
function msToolbar(p_msMap, _control, _default) {
  ...
  var _iconFullExtentButton = 'misc/img/world.png';  
  var _iconZoomboxButton = 'misc/img/focus.png';
  var _iconPanButton = 'misc/img/move.png';
  var _iconZoominButton = 'misc/img/plus.png';
  var _iconZoomoutButton = 'misc/img/minus.png';
